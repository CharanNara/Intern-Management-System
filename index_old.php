		...
		<div class="container-login100" style="background-image: url('images/agri.jpg');">
			<div class="wrap-login100 p-t-0 p-b-30">
				<form class="login100-form validate-form" action="" method="POST">
                          		<div class="login100-form-avatar" style="display:inline; margin-left: 130px" >
...
<a name="about">
	...
	<div class="limiter" >
		<div class="container-login100" style="background-image: url('images/agri.jpg');">
<div class="login100-form-title p-t-100 p-b-0 p-r-150 p-l-150">
<h1><font color="#00008B" size="6" style="font-family:  sans-serif;">ABOUT</br></font></h1>
...
<span >
					...
					<div>
						...
						<img src="images/face.png" alt="AVATAR" height="35" width="35">
