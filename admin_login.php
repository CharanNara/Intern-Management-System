...
{
    header("Location: admindash_intern.php");
}
			...
			<div class="wrap-login100 p-t-0 p-b-30">
				<form class="login100-form validate-form" action="" method="POST">
					...
					<span class="login100-form-title p-t-20 p-b-30">
                        ...
                        <span class="login100-form-title p-t-0 p-b-30" style="width: 500px;margin-left: 130px">
						<h4 style="color: grey">Admin Login</h4>
					...
					<!--<div class="text-center w-full" style="margin-top: 0px">
						<a class="txt1" href="intern-create-account.php">
							Create new account
