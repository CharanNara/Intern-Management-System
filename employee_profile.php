...
$collections = new MongoDB\Driver\Query(["Email"=>$_SESSION['employee']],['limit'=>1]);
...
if (isset($_POST["image_btn"]))
{
 ...
 $fileExt=explode('.', $fileName);
        ...
        if(in_array($fileActualExt, $allowed))
        {
          if($fileError===0){
            if($fileSize<10000000){
              ...
              $fileDestination='img/employee/'.$fileName;
    ...
    ['$set' => ['img_dir_path' => $fileDestination]]
              ...
              $updateResult = $conn->executeBulkWrite($db.'.'.'employee_document',$collections_u);
...
if(isset($_POST['submit_profile']))
{
   ...
   $updateResult2 = $conn->executeBulkWrite($db.'.'.'employee_document',$collections_u);
 ...
 $fileExt=explode('.', $fileName);
        ...
        if(in_array($fileActualExt, $allowed))
        {
          if($fileError===0){
              ...
              $fileDestination='nda_files/employee_nda/'.$fileName;
              move_uploaded_file($fileTempName, $fileDestination);
...
.container-login100 {
  ...
  z-index: 1;
    ...
    <aside>
          <?php
                $cursor2 = $conn->executeQuery($db.'.'.'employee_document',$collections);
     ...
     ?>   
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="employee_profile.php"><img src="<?php echo $cursor2->img_dir_path;?>" onerror=this.src="img/employee/employeepic.png" class="img-circle" width="80"></a></p>
        ...
        <div class="row">
          <div class="col-lg-9 main-chart">
            ...
            <div class="border-head">
              <h3><font color="black">Employee Profile</font></h3>
            </div>
      ...
      <form action="" method="POST">
            ...
            <div class="col-lg-3">
              <label for="fname">User Name</label>
               <input type="text" id="fname" name="emp_name" value="<?php echo $cursor2->Name;?>" disabled="true" >
            </div>
            <div class="col-lg-3">
              <label for="lname">Email - id</label>
              <input type="text" id="lname" name="emp_email" value="<?php echo $cursor2->Email;?>" disabled="true">
            </div>
             <div class="col-lg-3">
              <label for="lname">Role</label>
              <input type="text" id="lname" name="emp_role" value="<?php echo $cursor2->role;?>" disabled="true">
            </div>
          ...
          <!-- **********************************************************************************************************************************************************
           ...
           <div >
             <h4 class="centered mt">Your Profile</h4>
                  ...
                  <div id="profile-02">
                    <div class="user">
                      <img src="<?php echo $cursor2['img_dir_path']?>" class="img-circle" width="80">
