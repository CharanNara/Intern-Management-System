...
if (isset($_POST['submit']))
{
    ...
    if($cursor)
    {
   	...
   	$cursor2 = $conn->executeQuery($db.'.'.'admin_document');
    ...
    'pincode' =>'',
    'about' => ''
    //'taskfile' => ['files'=>'','dates'=>''] 
]);
    	$insertOneResult = $conn->executeBulkWrite($db.'.'.'intern_document',$collections_in);
   	header("Location: intern_login.php?status=success");
     }
     else{
			...
			<div class="wrap-login100 p-t-0 p-b-30">
				<form class="login100-form validate-form" action="" method="POST">
					...
					<span class="login100-form-title p-t-20 p-b-30">
						...
						<h4 style="color: grey">Create Account as Intern</h4>
