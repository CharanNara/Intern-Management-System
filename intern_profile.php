...
$collection_u = new MongoDB\Driver\BulkWrite(); 
$flg=$flg2=0;
$popupmsg=$popupmsg2='';
$default_country='';
        ...
        if(in_array($fileActualExt, $allowed))
        {
          if($fileError===0){
            if($fileSize<10000000){
              ...
              $fileDestination='img/intern/'.$fileName;
              move_uploaded_file($fileTempName, $fileDestination);
              print_r($fileDestination);
              $filedes=$fileDestination;
            $collection_u->update(
    ['Email' => $_SESSION['intern']],
    ['$set' => ['img_dir_path' => $fileDestination]],['multi' => false, 'upsert' => false]
);
            $UpdateRes = $conn->executeBulkWrite($db.'.'.'intern_document',$collection_u);
...
if(isset($_POST['submit_profile']))
{
    ...
    $updateResult2 = $conn->executeBulkWrite($db.'.'.'intern_document',$collection_u);
 ...
 $fileExt=explode('.', $fileName);
        ...
        if(in_array($fileActualExt, $allowed))
        {
          if($fileError===0){
              ...
              $fileDestination='nda_files/intern_nda/'.$fileName;
              move_uploaded_file($fileTempName, $fileDestination);
...
.container-login100 {
  ...
  z-index: 1;
    ...
    <aside>
          <?php
                $cursor2 = $conn->executeQuery($db.'.'.'intern_document',$collections);
                $cursor2 = $cursor2->toArray()[0];
     ?>   
      <div id="sidebar" class="nav-collapse ">
        <!-- sidebar menu start-->
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="intern_profile.php"><img src="<?php echo $cursor2->img_dir_path;?>" class="img-circle" width="80"></a></p>
          <h5 class="centered"><?php echo $cursor2->name;?></h5>
          <li class="mt">
            <a href="intern_dashboard.php">
        ...
        <div class="row">
          <div class="col-lg-9 main-chart">
            ...
            <div class="border-head">
              <h3><font color="black">Intern Profile</font></h3>
            </div>
          ...
          <!-- **********************************************************************************************************************************************************
           ...
           <div >
             <h4 class="centered mt">Your Profile</h4>
                  ...
                  <div id="profile-02">
                    <div class="user">
                      <img src="<?php echo $cursor2->img_dir_path?>"  onerror=this.src="img/intern/internpic.png" class="img-circle" width="80">
